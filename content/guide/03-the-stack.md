...
You can predict the stack state after any sequence of numbers and arithmetic. The next chapter introduces word definitions, where you'll start naming your own operations and building a vocabulary.
